...
<div id="main" class="container">
    <div class="p-4 lg:p-8" style="width:45%">
        <div class="text-left">
            <div>
                <h2 class="font-semibold text-xl">CREATE NEW SUDENT</h2>
                <p>Enter new student data in the form below</p>
                <br>
                ...
                >
                    ...
                    <div class="flex flex-grow-1 items-center justify-between">
                        <label for="group_id">Select a Group name &nbsp;</label>
                        <?php
                        $groupsList = \App\Models\Groups::all();
                        ?>
                        <select id="group_id" name="group_id" class="px-2 py-1 border border-info border-solid">
