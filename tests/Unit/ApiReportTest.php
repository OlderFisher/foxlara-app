...
class ApiReportTest extends TestCase
{
    ...
    public function testApiStudentGroupUpdate(): void
    {
        ...
        $student['group_name'] = $this->getGroupNameById($singleStudentCollection->group_id);
        ...
        $student['group_name'] = $this->getGroupNameById($group['id']);

        $apiResponse->assertStatus(200);
        $apiResponse->assertJsonFragment($student);
    }

    private function getGroupNameById(string $id): string
    {
